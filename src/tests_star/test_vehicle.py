...
class StarWarsTest(unittest.TestCase):
    def test_specie(self):
        vehicle = Vehicle(14)
        self.assertEqual(vehicle.get_films(), {'The Empire Strikes Back': '2'}, "should {'The Empire Strikes Back': '2'}")
        self.assertEqual(vehicle.get_pilots(), {'Luke Skywalker': '1', 'Wedge Antilles': '18'},
                         "should {'Luke Skywalker': '1', 'Wedge Antilles': '18'}")
